...
public class Ventana0301c extends JFrame{
    ...
    public void iniciarPaneles(){
        ...
        this.jPanelList.get(1).add(this.jPanelList.get(5),BorderLayout.CENTER);
        this.jPanelList.get(1).add(this.jPanelList.get(6),BorderLayout.WEST);
        this.jPanelList.get(1).add(this.jPanelList.get(7),BorderLayout.NORTH);
        this.jPanelList.get(1).add(this.jPanelList.get(8),BorderLayout.EAST);
        
        this.jPanelList.get(2).add(this.jPanelList.get(9),BorderLayout.WEST);
        this.jPanelList.get(2).add(this.jPanelList.get(10),BorderLayout.CENTER);
        
        this.jPanelList.get(3).add(this.jPanelList.get(11),BorderLayout.EAST);
        this.jPanelList.get(3).add(this.jPanelList.get(12),BorderLayout.NORTH);
        this.jPanelList.get(3).add(this.jPanelList.get(13),BorderLayout.CENTER);
